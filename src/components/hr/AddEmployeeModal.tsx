      ...
      <DialogContent className="sm:max-w-[425px]">
        ...
        <form onSubmit={form.handleSubmit(onSubmit)} className="grid gap-4 py-4">
          <div className="grid grid-cols-4 items-center gap-4">
            ...
            {form.formState.errors.id && <p className="col-span-4 text-right text-sm text-destructive">{form.formState.errors.id.message}</p>}
          </div>
          <div className="grid grid-cols-4 items-center gap-4">
          ...
          <div className="grid grid-cols-4 items-center gap-4">
            ...
            <Input id="passwordInput" type="password" {...form.register('passwordInput')} className="col-span-3" />
